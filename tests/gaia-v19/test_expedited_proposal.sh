...
echo "Calculate height for mock v20 upgrade expedited proposal"
...
jq --arg HEIGHT "$upgrade_height" '.messages[0].plan.height = $HEIGHT' templates/gaia-v19/proposal-upgrade-v20.json > proposal.json
