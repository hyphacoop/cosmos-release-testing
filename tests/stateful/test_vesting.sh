...
$CHAIN_BINARY --home $HOME_1 bank send $WALLET_1 $vesting_wallet2_addr 1000000$DENOM --from $MONIKER_1 --gas $GAS --gas-adjustment $GAS_ADJUSTMENT --fees $BASE_FEES$DENOM -y
