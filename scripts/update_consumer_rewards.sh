...
jq --arg denom "$provider_denom" --arg denom2 "$utoken1_denom" --arg denom3 "$utoken2_denom" --arg denom4 "$atoken3_denom" '.allowlisted_reward_denoms |= { "denoms":[$denom,$denom2,$denom3,$denom4] }' update.json > update-denom.json
