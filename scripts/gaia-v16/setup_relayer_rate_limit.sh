...
if [ $RELAYER == "hermes" ]; then
    ...
    hermes keys add --chain core-1 --mnemonic-file mnemonic.txt
    hermes keys add --chain injective-1 --mnemonic-file mnemonic.txt
    hermes keys add --chain secret-4 --mnemonic-file mnemonic.txt
    hermes keys add --chain kaiyo-1 --mnemonic-file mnemonic.txt
    hermes keys add --chain stride-1 --mnemonic-file mnemonic.txt
