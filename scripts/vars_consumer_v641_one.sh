...
export CONSUMER_CHAIN_BINARY_URL=https://github.com/hyphacoop/cosmos-builds/releases/download/ics-v6.4.1/interchain-security-cd-linux
export CONSUMER_CHAIN_BINARY_NAME="consumerd-v641-one"
export CONSUMER_CHAIN_BINARY="$CONSUMER_CHAIN_BINARY_NAME"
export CONSUMER_CHAIN_ID=v641-one
...
export CONSUMER_ICS="v6.4.1"

export consumer_moniker_prefix='con641_'
export consumer_home_prefix='/home/runner/.con641_'
...
export consumer_log_prefix="con641log_"
