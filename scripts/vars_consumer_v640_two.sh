...
export CONSUMER_CHAIN_BINARY_NAME="consumerd-v640-two"
export CONSUMER_CHAIN_BINARY="$CONSUMER_CHAIN_BINARY_NAME"
export CONSUMER_CHAIN_ID=v640-two
...
export consumer_moniker_prefix='con650_'
export consumer_home_prefix='/home/runner/.con650_'
export consumer_api_prefix="651"
export consumer_p2p_prefix="652"
export consumer_rpc_prefix="653"
export consumer_grpc_prefix="654"
export consumer_pprof_prefix="655"
export consumer_log_prefix="con65log_"
