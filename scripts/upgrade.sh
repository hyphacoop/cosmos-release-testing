...
$CHAIN_BINARY tx gov submit-legacy-proposal --proposal proposal-upgrade-consumer.json --home $whale_home --from $WALLET_1 --gas $GAS --gas-adjustment $GAS_ADJUSTMENT --gas-prices $GAS_PRICE -y
